...
void main() {
  group('performance regressions', () {
    test('local installer delegates to Pub path activation', () async {
...
''');
      ...
      expect(output['compiledSnapshotCache'], isTrue);
      expect(
        File(p.join(pubCache.path, 'bin', 'flutter-scout')).existsSync(),
        isTrue,
      );
    });
